...
Module Info.
  ...
  Definition source_file := "crypto/fipsmodule/digest/digest.c"%string.
...
Definition v___stringlit_1 := {|
  ...
  gvar_init := (Init_int8 (Int.repr 99) :: Init_int8 (Int.repr 114) ::
                Init_int8 (Int.repr 121) :: Init_int8 (Int.repr 112) ::
                Init_int8 (Int.repr 116) :: Init_int8 (Int.repr 111) ::
                Init_int8 (Int.repr 47) :: Init_int8 (Int.repr 102) ::
                ...
                Init_int8 (Int.repr 47) :: Init_int8 (Int.repr 100) ::
...
Definition f_EVP_MD_CTX_create := {|
  ...
  fn_params := nil;
  fn_vars := nil;
  fn_temps := ((_t'1, (tptr (Tstruct _env_md_ctx_st noattr))) :: nil);
  fn_body :=
(Ssequence
  (Scall (Some _t'1)
    (Evar _EVP_MD_CTX_new (Tfunction Tnil
                            (tptr (Tstruct _env_md_ctx_st noattr))
                            cc_default)) nil)
  (Sreturn (Some (Etempvar _t'1 (tptr (Tstruct _env_md_ctx_st noattr))))))
|}.
...
Definition f_EVP_MD_CTX_cleanup := {|
  ...
  fn_params := ((_ctx, (tptr (Tstruct _env_md_ctx_st noattr))) :: nil);
  fn_vars := nil;
  fn_temps := ((_t'5, (tptr tvoid)) ::
               (_t'4, (tptr (Tstruct _evp_pkey_ctx_st noattr))) ::
               (_t'3,
                (tptr (Tfunction
                        (Tcons (tptr (Tstruct _evp_pkey_ctx_st noattr)) Tnil)
                        tvoid cc_default))) ::
               (_t'2, (tptr (Tstruct _evp_md_pctx_ops noattr))) ::
               (_t'1, (tptr (Tstruct _evp_md_pctx_ops noattr))) :: nil);
  fn_body :=
(Ssequence
  (Ssequence
    (Sset _t'5
    ...
    (Scall None
      (Evar _OPENSSL_free (Tfunction (Tcons (tptr tvoid) Tnil) tvoid
                            cc_default))
  ...
  (Ssequence
    (Ssequence
      ...
      (Sifthenelse (Etempvar _t'1 (tptr (Tstruct _evp_md_pctx_ops noattr)))
        (Ssequence
          (Sset _t'2
            (Efield
              (Ederef (Etempvar _ctx (tptr (Tstruct _env_md_ctx_st noattr)))
          ...
          (Ssequence
            (Sset _t'3
              (Efield
                (Ederef
                  (Etempvar _t'2 (tptr (Tstruct _evp_md_pctx_ops noattr)))
...
Definition f_EVP_MD_CTX_destroy := {|
  ...
  fn_body :=
(Scall None
  (Evar _EVP_MD_CTX_free (Tfunction
...
Definition f_EVP_MD_CTX_copy_ex := {|
  ...
  fn_vars := nil;
  fn_temps := ((_pctx, (tptr (Tstruct _evp_pkey_ctx_st noattr))) ::
               (_tmp_buf, (tptr tuchar)) :: (_t'3, (tptr tvoid)) ::
               (_t'2, (tptr (Tstruct _evp_pkey_ctx_st noattr))) ::
               (_t'1, tint) :: (_t'20, (tptr (Tstruct _env_md_st noattr))) ::
               (_t'19, (tptr (Tstruct _evp_pkey_ctx_st noattr))) ::
               (_t'18,
                (tptr (Tfunction
                        (Tcons (tptr (Tstruct _evp_pkey_ctx_st noattr)) Tnil)
                        (tptr (Tstruct _evp_pkey_ctx_st noattr)) cc_default))) ::
               (_t'17, (tptr (Tstruct _evp_md_pctx_ops noattr))) ::
               (_t'16, (tptr (Tstruct _evp_pkey_ctx_st noattr))) ::
               (_t'15, tuint) ::
               (_t'14, (tptr (Tstruct _env_md_st noattr))) ::
               (_t'13,
                (tptr (Tfunction
                        (Tcons (tptr (Tstruct _evp_pkey_ctx_st noattr)) Tnil)
                        tvoid cc_default))) ::
               ...
               (_t'9, (tptr (Tstruct _env_md_st noattr))) :: (_t'8, tuint) ::
               (_t'7, (tptr (Tstruct _env_md_st noattr))) ::
               (_t'6, (tptr tvoid)) :: (_t'5, (tptr tvoid)) ::
               (_t'4, (tptr (Tstruct _evp_md_pctx_ops noattr))) :: nil);
  fn_body :=
(Ssequence
  (Ssequence
    (Sifthenelse (Ebinop Oeq
      ...
      (Ssequence
        ...
        (Sset _t'1
          (Ecast
            (Ebinop Oeq (Etempvar _t'20 (tptr (Tstruct _env_md_st noattr)))
              (Ecast (Econst_int (Int.repr 0) tint) (tptr tvoid)) tint)
            tbool))))
      ...
      (Ssequence
        (Scall None
          ...
          ((Econst_int (Int.repr 29) tint) ::
           ...
           (Econst_int (Int.repr 120) tint) :: nil))
        (Sreturn (Some (Econst_int (Int.repr 0) tint))))
      Sskip))
  (Ssequence
    (Sset _pctx (Ecast (Econst_int (Int.repr 0) tint) (tptr tvoid)))
    (Ssequence
      (Ssequence
        (Sset _t'16
          (Efield
            (Ederef (Etempvar _in (tptr (Tstruct _env_md_ctx_st noattr)))
              (Tstruct _env_md_ctx_st noattr)) _pctx
            (tptr (Tstruct _evp_pkey_ctx_st noattr))))
        (Sifthenelse (Etempvar _t'16 (tptr (Tstruct _evp_pkey_ctx_st noattr)))
          (Ssequence
            (Ssequence
              (Ssequence
                (Sset _t'17
                ...
                (Ssequence
                  (Sset _t'18
                    (Efield
                      (Ederef
                        (Etempvar _t'17 (tptr (Tstruct _evp_md_pctx_ops noattr)))
                        (Tstruct _evp_md_pctx_ops noattr)) _dup
                      (tptr (Tfunction
                              (Tcons (tptr (Tstruct _evp_pkey_ctx_st noattr))
                                Tnil)
                              (tptr (Tstruct _evp_pkey_ctx_st noattr))
                              cc_default))))
                  (Ssequence
                    ...
                    (Scall (Some _t'2)
                      (Etempvar _t'18 (tptr (Tfunction
                                              ...
                                              (tptr (Tstruct _evp_pkey_ctx_st noattr))
                                              cc_default)))
                      ((Etempvar _t'19 (tptr (Tstruct _evp_pkey_ctx_st noattr))) ::
                       nil)))))
              (Sset _pctx
                (Etempvar _t'2 (tptr (Tstruct _evp_pkey_ctx_st noattr)))))
            (Sifthenelse (Eunop Onotbool
                           (Etempvar _pctx (tptr (Tstruct _evp_pkey_ctx_st noattr)))
                           tint)
              (Ssequence
                (Scall None
                  (Evar _ERR_put_error (Tfunction
        ...
        (Ssequence
          ...
          (Ssequence
            ...
            (Sifthenelse (Ebinop One
                           (Etempvar _t'10 (tptr (Tstruct _env_md_st noattr)))
                  ...
                  (Ssequence
                    ...
                    (Ssequence
                      (Sset _t'15
                        (Efield
                          (Ederef
                            (Etempvar _t'14 (tptr (Tstruct _env_md_st noattr)))
                            (Tstruct _env_md_st noattr)) _ctx_size tuint))
                      (Scall (Some _t'3)
                        (Evar _OPENSSL_malloc (Tfunction (Tcons tuint Tnil)
                                                (tptr tvoid) cc_default))
                        ((Etempvar _t'15 tuint) :: nil))))
                  (Sset _tmp_buf (Etempvar _t'3 (tptr tvoid))))
                (Sifthenelse (Ebinop Oeq (Etempvar _tmp_buf (tptr tuchar))
                               (Ecast (Econst_int (Int.repr 0) tint)
                                 (tptr tvoid)) tint)
                  (Ssequence
                    (Sifthenelse (Etempvar _pctx (tptr (Tstruct _evp_pkey_ctx_st noattr)))
                      (Ssequence
                        (Sset _t'12
                          (Efield
                            (Ederef
              ...
              (Sassign
                (Efield
                  (Ederef
                    ...
                    (Tstruct _env_md_ctx_st noattr)) _digest
                  (tptr (Tstruct _env_md_st noattr)))
                (Etempvar _t'9 (tptr (Tstruct _env_md_st noattr)))))
            (Ssequence
              (Sassign
                (Efield
                  (Ederef
                    ...
                    (Ssequence
                      ...
                      (Ssequence
                        (Sset _t'8
                          (Efield
                            (Ederef
                              (Etempvar _t'7 (tptr (Tstruct _env_md_st noattr)))
                              (Tstruct _env_md_st noattr)) _ctx_size tuint))
                        (Scall None
...
Definition f_EVP_DigestInit_ex := {|
  ...
  fn_vars := nil;
  fn_temps := ((_md_data, (tptr tuchar)) :: (_t'1, (tptr tvoid)) ::
               (_t'6, tuint) :: (_t'5, (tptr tvoid)) ::
               (_t'4, (tptr (Tstruct _env_md_st noattr))) ::
               (_t'3,
                (tptr (Tfunction
                        (Tcons (tptr (Tstruct _env_md_ctx_st noattr)) Tnil)
                        tvoid cc_default))) ::
               (_t'2, (tptr (Tstruct _env_md_st noattr))) :: nil);
  fn_body :=
(Ssequence
  (Ssequence
    (Sset _t'4
      (Efield
        ...
        (tptr (Tstruct _env_md_st noattr))))
    (Sifthenelse (Ebinop One
                   (Etempvar _t'4 (tptr (Tstruct _env_md_st noattr)))
      ...
      (Ssequence
        (Ssequence
          ...
          (Sset _md_data (Etempvar _t'1 (tptr tvoid))))
        (Ssequence
          (Sifthenelse (Ebinop Oeq (Etempvar _md_data (tptr tuchar))
                         (Ecast (Econst_int (Int.repr 0) tint) (tptr tvoid))
                         tint)
            (Ssequence
              (Scall None
...
((___stringlit_1, Gvar v___stringlit_1) ::
 ...
 (_ERR_put_error,
   Gfun(External (EF_external "ERR_put_error"
     ...
     tvoid cc_default)) ::
 (_OPENSSL_malloc,
   Gfun(External (EF_external "OPENSSL_malloc"
                   (mksignature (AST.Tint :: nil) (Some AST.Tint) cc_default))
     (Tcons tuint Tnil) (tptr tvoid) cc_default)) ::
 (_OPENSSL_free,
   Gfun(External (EF_external "OPENSSL_free"
                   (mksignature (AST.Tint :: nil) None cc_default))
     (Tcons (tptr tvoid) Tnil) tvoid cc_default)) ::
 (_OPENSSL_cleanse,
 ...
 (_EVP_MD_CTX_reset, Gfun(Internal f_EVP_MD_CTX_reset)) ::
...
(_EVP_add_digest :: _EVP_MD_CTX_type :: _EVP_MD_CTX_block_size ::
 ...
 _EVP_DigestInit_ex :: _EVP_MD_CTX_reset :: _EVP_MD_CTX_copy ::
 _EVP_MD_CTX_copy_ex :: _EVP_MD_CTX_destroy :: _EVP_MD_CTX_free ::
 _EVP_MD_CTX_cleanup :: _EVP_MD_CTX_create :: _EVP_MD_CTX_new ::
 _EVP_MD_CTX_init :: _EVP_MD_block_size :: _EVP_MD_size :: _EVP_MD_flags ::
 _EVP_MD_type :: _OPENSSL_cleanse :: _OPENSSL_free :: _OPENSSL_malloc ::
 _ERR_put_error :: _memset :: _memcpy :: ___builtin_debug ::
