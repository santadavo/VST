...
Module Info.
  ...
  Definition source_file := "crypto/fipsmodule/digest/digests.c"%string.
  Definition normalized := true.
End Info.

Definition _BIO_snprintf : ident := 101%positive.
Definition _BIO_vsnprintf : ident := 100%positive.
Definition _CRYPTO_MUTEX_cleanup : ident := 112%positive.
Definition _CRYPTO_MUTEX_init : ident := 107%positive.
Definition _CRYPTO_MUTEX_lock_read : ident := 108%positive.
Definition _CRYPTO_MUTEX_lock_write : ident := 109%positive.
Definition _CRYPTO_MUTEX_unlock_read : ident := 110%positive.
Definition _CRYPTO_MUTEX_unlock_write : ident := 111%positive.
Definition _CRYPTO_STATIC_MUTEX : ident := 105%positive.
Definition _CRYPTO_STATIC_MUTEX_lock_read : ident := 113%positive.
Definition _CRYPTO_STATIC_MUTEX_lock_write : ident := 114%positive.
Definition _CRYPTO_STATIC_MUTEX_unlock_read : ident := 115%positive.
Definition _CRYPTO_STATIC_MUTEX_unlock_write : ident := 116%positive.
Definition _CRYPTO_get_thread_local : ident := 122%positive.
Definition _CRYPTO_memcmp : ident := 83%positive.
Definition _CRYPTO_once : ident := 119%positive.
Definition _CRYPTO_set_thread_local : ident := 125%positive.
Definition _ERR_put_error : ident := 142%positive.
Definition _EVP_Digest : ident := 174%positive.
Definition _EVP_DigestFinal : ident := 169%positive.
Definition _EVP_DigestFinal_ex : ident := 168%positive.
Definition _EVP_DigestInit : ident := 164%positive.
Definition _EVP_DigestInit_ex : ident := 163%positive.
Definition _EVP_DigestUpdate : ident := 166%positive.
Definition _EVP_MD_CTX_block_size : ident := 177%positive.
Definition _EVP_MD_CTX_cleanup : ident := 152%positive.
Definition _EVP_MD_CTX_copy : ident := 159%positive.
Definition _EVP_MD_CTX_copy_ex : ident := 158%positive.
Definition _EVP_MD_CTX_create : ident := 151%positive.
Definition _EVP_MD_CTX_destroy : ident := 154%positive.
Definition _EVP_MD_CTX_free : ident := 153%positive.
Definition _EVP_MD_CTX_init : ident := 149%positive.
Definition _EVP_MD_CTX_md : ident := 175%positive.
Definition _EVP_MD_CTX_new : ident := 150%positive.
Definition _EVP_MD_CTX_reset : ident := 160%positive.
Definition _EVP_MD_CTX_size : ident := 176%positive.
Definition _EVP_MD_CTX_type : ident := 178%positive.
Definition _EVP_MD_block_size : ident := 147%positive.
Definition _EVP_MD_flags : ident := 145%positive.
Definition _EVP_MD_size : ident := 146%positive.
Definition _EVP_MD_type : ident := 144%positive.
Definition _EVP_add_digest : ident := 179%positive.
Definition _EVP_md4 : ident := 234%positive.
Definition _EVP_md4_do_init : ident := 232%positive.
Definition _EVP_md4_init : ident := 233%positive.
Definition _EVP_md4_once : ident := 230%positive.
Definition _EVP_md4_once_bss_get : ident := 231%positive.
Definition _EVP_md4_storage : ident := 228%positive.
Definition _EVP_md4_storage_bss_get : ident := 229%positive.
Definition _EVP_md5 : ident := 244%positive.
Definition _EVP_md5_do_init : ident := 242%positive.
Definition _EVP_md5_init : ident := 243%positive.
Definition _EVP_md5_once : ident := 240%positive.
Definition _EVP_md5_once_bss_get : ident := 241%positive.
Definition _EVP_md5_sha1 : ident := 305%positive.
Definition _EVP_md5_sha1_do_init : ident := 303%positive.
Definition _EVP_md5_sha1_init : ident := 304%positive.
Definition _EVP_md5_sha1_once : ident := 301%positive.
Definition _EVP_md5_sha1_once_bss_get : ident := 302%positive.
Definition _EVP_md5_sha1_storage : ident := 299%positive.
Definition _EVP_md5_sha1_storage_bss_get : ident := 300%positive.
Definition _EVP_md5_storage : ident := 238%positive.
Definition _EVP_md5_storage_bss_get : ident := 239%positive.
Definition _EVP_sha1 : ident := 254%positive.
Definition _EVP_sha1_do_init : ident := 252%positive.
Definition _EVP_sha1_init : ident := 253%positive.
Definition _EVP_sha1_once : ident := 250%positive.
Definition _EVP_sha1_once_bss_get : ident := 251%positive.
Definition _EVP_sha1_storage : ident := 248%positive.
Definition _EVP_sha1_storage_bss_get : ident := 249%positive.
Definition _EVP_sha224 : ident := 264%positive.
Definition _EVP_sha224_do_init : ident := 262%positive.
Definition _EVP_sha224_init : ident := 263%positive.
Definition _EVP_sha224_once : ident := 260%positive.
Definition _EVP_sha224_once_bss_get : ident := 261%positive.
Definition _EVP_sha224_storage : ident := 258%positive.
Definition _EVP_sha224_storage_bss_get : ident := 259%positive.
Definition _EVP_sha256 : ident := 274%positive.
Definition _EVP_sha256_do_init : ident := 272%positive.
Definition _EVP_sha256_init : ident := 273%positive.
Definition _EVP_sha256_once : ident := 270%positive.
Definition _EVP_sha256_once_bss_get : ident := 271%positive.
Definition _EVP_sha256_storage : ident := 268%positive.
Definition _EVP_sha256_storage_bss_get : ident := 269%positive.
Definition _EVP_sha384 : ident := 284%positive.
Definition _EVP_sha384_do_init : ident := 282%positive.
Definition _EVP_sha384_init : ident := 283%positive.
Definition _EVP_sha384_once : ident := 280%positive.
Definition _EVP_sha384_once_bss_get : ident := 281%positive.
Definition _EVP_sha384_storage : ident := 278%positive.
Definition _EVP_sha384_storage_bss_get : ident := 279%positive.
Definition _EVP_sha512 : ident := 294%positive.
Definition _EVP_sha512_do_init : ident := 292%positive.
Definition _EVP_sha512_init : ident := 293%positive.
Definition _EVP_sha512_once : ident := 290%positive.
Definition _EVP_sha512_once_bss_get : ident := 291%positive.
Definition _EVP_sha512_storage : ident := 288%positive.
Definition _EVP_sha512_storage_bss_get : ident := 289%positive.
Definition _MD4_Final : ident := 206%positive.
Definition _MD4_Init : ident := 204%positive.
Definition _MD4_Update : ident := 205%positive.
Definition _MD5_Final : ident := 209%positive.
Definition _MD5_Init : ident := 207%positive.
Definition _MD5_Update : ident := 208%positive.
Definition _Nh : ident := 181%positive.
Definition _Nl : ident := 180%positive.
...
Definition _SHA1_Final : ident := 212%positive.
Definition _SHA1_Init : ident := 210%positive.
Definition _SHA1_Update : ident := 211%positive.
Definition _SHA224_Final : ident := 215%positive.
Definition _SHA224_Init : ident := 213%positive.
Definition _SHA224_Update : ident := 214%positive.
Definition _SHA256_Final : ident := 218%positive.
Definition _SHA256_Init : ident := 216%positive.
Definition _SHA256_Update : ident := 217%positive.
Definition _SHA384_Final : ident := 221%positive.
Definition _SHA384_Init : ident := 219%positive.
Definition _SHA384_Update : ident := 220%positive.
Definition _SHA512_Final : ident := 224%positive.
Definition _SHA512_Init : ident := 222%positive.
Definition _SHA512_Update : ident := 223%positive.
Definition __4593 : ident := 192%positive.
Definition __4594 : ident := 190%positive.
Definition __4660 : ident := 198%positive.
Definition __5375 : ident := 203%positive.
...
Definition ___stringlit_1 : ident := 157%positive.
...
Definition _block_size : ident := 139%positive.
Definition _buf : ident := 97%positive.
Definition _c : ident := 63%positive.
Definition _count : ident := 170%positive.
Definition _crypto_mutex_st : ident := 104%positive.
Definition _ctx : ident := 148%positive.
Definition _ctx_size : ident := 140%positive.
Definition _d : ident := 196%positive.
Definition _data : ident := 165%positive.
Definition _destructor : ident := 124%positive.
Definition _digest : ident := 127%positive.
Definition _dst : ident := 59%positive.
Definition _dup : ident := 141%positive.
Definition _engine : ident := 161%positive.
Definition _engine_st : ident := 162%positive.
Definition _env_md_ctx_st : ident := 133%positive.
Definition _env_md_st : ident := 126%positive.
Definition _evp_md_pctx_ops : ident := 131%positive.
Definition _evp_pkey_ctx_st : ident := 129%positive.
Definition _final : ident := 138%positive.
Definition _flags : ident := 136%positive.
Definition _format : ident := 98%positive.
Definition _free : ident := 54%positive.
Definition _g_thread_locals : ident := 120%positive.
Definition _h : ident := 87%positive.
Definition _h0 : ident := 185%positive.
Definition _h1 : ident := 186%positive.
Definition _h2 : ident := 187%positive.
Definition _h3 : ident := 188%positive.
Definition _h4 : ident := 189%positive.
Definition _i : ident := 82%positive.
Definition _impl : ident := 173%positive.
Definition _in : ident := 86%positive.
Definition _in_a : ident := 77%positive.
Definition _in_b : ident := 78%positive.
Definition _index : ident := 121%positive.
Definition _init : ident := 118%positive.
Definition _kOffsetBasis : ident := 85%positive.
Definition _kPrime : ident := 84%positive.
Definition _len : ident := 76%positive.
Definition _lock : ident := 106%positive.
Definition _main : ident := 102%positive.
Definition _malloc : ident := 53%positive.
Definition _md : ident := 143%positive.
Definition _md4_final : ident := 227%positive.
Definition _md4_init : ident := 225%positive.
Definition _md4_state_st : ident := 183%positive.
Definition _md4_update : ident := 226%positive.
Definition _md5 : ident := 201%positive.
Definition _md5_final : ident := 237%positive.
Definition _md5_init : ident := 235%positive.
Definition _md5_sha1_final : ident := 298%positive.
Definition _md5_sha1_init : ident := 296%positive.
Definition _md5_sha1_update : ident := 297%positive.
Definition _md5_state_st : ident := 184%positive.
Definition _md5_update : ident := 236%positive.
Definition _md_ctx : ident := 295%positive.
Definition _md_data : ident := 128%positive.
Definition _md_len : ident := 194%positive.
Definition _md_out : ident := 167%positive.
Definition _md_size : ident := 135%positive.
...
Definition _num : ident := 182%positive.
Definition _old_size : ident := 72%positive.
Definition _once : ident := 117%positive.
Definition _orig_ptr : ident := 68%positive.
Definition _out : ident := 155%positive.
Definition _out_md : ident := 171%positive.
Definition _out_size : ident := 172%positive.
Definition _p : ident := 197%positive.
Definition _padding : ident := 103%positive.
Definition _pctx : ident := 130%positive.
Definition _pctx_ops : ident := 132%positive.
Definition _ptr : ident := 66%positive.
Definition _ret : ident := 73%positive.
Definition _s : ident := 89%positive.
Definition _sha1 : ident := 202%positive.
Definition _sha1_final : ident := 247%positive.
Definition _sha1_init : ident := 245%positive.
Definition _sha1_update : ident := 246%positive.
Definition _sha224_final : ident := 257%positive.
Definition _sha224_init : ident := 255%positive.
Definition _sha224_update : ident := 256%positive.
Definition _sha256_final : ident := 267%positive.
Definition _sha256_init : ident := 265%positive.
Definition _sha256_state_st : ident := 195%positive.
Definition _sha256_update : ident := 266%positive.
Definition _sha384_final : ident := 277%positive.
Definition _sha384_init : ident := 275%positive.
Definition _sha384_update : ident := 276%positive.
Definition _sha512_final : ident := 287%positive.
Definition _sha512_init : ident := 285%positive.
Definition _sha512_state_st : ident := 200%positive.
Definition _sha512_update : ident := 286%positive.
Definition _sha_state_st : ident := 193%positive.
Definition _size : ident := 65%positive.
Definition _src : ident := 60%positive.
Definition _strlen : ident := 58%positive.
Definition _tmp_buf : ident := 156%positive.
Definition _to_copy : ident := 74%positive.
Definition _type : ident := 134%positive.
Definition _u : ident := 199%positive.
Definition _update : ident := 137%positive.
Definition _value : ident := 123%positive.
Definition _vsnprintf : ident := 55%positive.
Definition _x : ident := 81%positive.
Definition _t'1 : ident := 306%positive.
Definition _t'2 : ident := 307%positive.
Definition _t'3 : ident := 308%positive.
...
Definition f_md5_sha1_init := {|
  ...
  fn_vars := nil;
  fn_temps := ((_ctx, (tptr (Tstruct __5375 noattr))) :: (_t'3, tint) ::
...
(Ssequence
  ...
  (Ssequence
    (Scall (Some _t'1)
      ...
      ((Eaddrof
         (Efield
           (Ederef (Etempvar _ctx (tptr (Tstruct __5375 noattr)))
             (Tstruct __5375 noattr)) _md5 (Tstruct _md5_state_st noattr))
            ...
            (Ssequence
              ...
              (Sassign
                (Efield
                  (Ederef (Etempvar _out (tptr (Tstruct _env_md_st noattr)))
                    (Tstruct _env_md_st noattr)) _ctx_size tuint)
                (Esizeof (Tstruct __5375 noattr) tuint)))))))))
|}.
...
(Composite _env_md_ctx_st Struct
 ...
 Composite _md5_state_st Struct
   ((_h, (tarray tuint 4)) :: (_Nl, tuint) :: (_Nh, tuint) ::
    (_data, (tarray tuchar 64)) :: (_num, tuint) :: nil)
   noattr ::
 Composite __4594 Struct
   ((_h0, tuint) :: (_h1, tuint) :: (_h2, tuint) :: (_h3, tuint) ::
    (_h4, tuint) :: nil)
   noattr ::
 Composite __4593 Union
   ((_h, (tarray tuint 5)) :: (191%positive, (Tstruct __4594 noattr)) :: nil)
   noattr ::
 Composite _sha_state_st Struct
   ((191%positive, (Tunion __4593 noattr)) :: (_Nl, tuint) :: (_Nh, tuint) ::
    (_data, (tarray tuchar 64)) :: (_num, tuint) :: nil)
   noattr ::
