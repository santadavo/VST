...
(*
Definition AbsGprog: funspecs := [EVP_MD_CTX_init_SPEC].
*)
...
+ (*Allocated*)
  ...
  - apply prop_right. Intros rv. Exists rv. simplify_Delta. unfold DIE_postMpred.
    old_go_lower; entailer; cancel.
    rewrite sepcon_comm, distrib_orp_sepcon. apply orp_left.
    * Intros; subst. rewrite if_true by trivial. unfold MDCTXRaw, CTX_NULL. entailer!.
    * Intros m; subst. rewrite if_false by discriminate.
      rewrite OPENSSL_malloc_token_compatible' with (v:=m); Intros. entailer!.
      Exists m. unfold MDCTXEmpty, EVP_MD_CTX_NNnode. entailer!.
+ (*Raw*) 
  replace_SEP 0 (MDCTXRaw ctx) by entailer!. 
