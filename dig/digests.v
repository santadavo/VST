...
Module Info.
  ...
  Definition source_file := "digests.c"%string.
  Definition normalized := true.
End Info.

Definition _CRYPTO_once : ident := 167%positive.
Definition _ERR_put_error : ident := 73%positive.
Definition _EVP_Digest : ident := 114%positive.
Definition _EVP_DigestFinal : ident := 108%positive.
Definition _EVP_DigestFinal_ex : ident := 107%positive.
Definition _EVP_DigestInit : ident := 101%positive.
Definition _EVP_DigestInit_ex : ident := 100%positive.
Definition _EVP_DigestUpdate : ident := 104%positive.
Definition _EVP_MD_CTX_block_size : ident := 117%positive.
Definition _EVP_MD_CTX_cleanup : ident := 90%positive.
Definition _EVP_MD_CTX_copy : ident := 97%positive.
Definition _EVP_MD_CTX_copy_ex : ident := 96%positive.
Definition _EVP_MD_CTX_create : ident := 89%positive.
Definition _EVP_MD_CTX_destroy : ident := 91%positive.
Definition _EVP_MD_CTX_init : ident := 88%positive.
Definition _EVP_MD_CTX_md : ident := 115%positive.
Definition _EVP_MD_CTX_size : ident := 116%positive.
Definition _EVP_MD_CTX_type : ident := 118%positive.
Definition _EVP_MD_block_size : ident := 86%positive.
Definition _EVP_MD_flags : ident := 84%positive.
Definition _EVP_MD_size : ident := 85%positive.
Definition _EVP_MD_type : ident := 83%positive.
Definition _EVP_add_digest : ident := 119%positive.
Definition _EVP_md4 : ident := 177%positive.
Definition _EVP_md4_do_init : ident := 175%positive.
Definition _EVP_md4_init : ident := 176%positive.
Definition _EVP_md4_once : ident := 173%positive.
Definition _EVP_md4_once_bss_get : ident := 174%positive.
Definition _EVP_md4_storage : ident := 171%positive.
Definition _EVP_md4_storage_bss_get : ident := 172%positive.
Definition _EVP_md5 : ident := 187%positive.
Definition _EVP_md5_do_init : ident := 185%positive.
Definition _EVP_md5_init : ident := 186%positive.
Definition _EVP_md5_once : ident := 183%positive.
Definition _EVP_md5_once_bss_get : ident := 184%positive.
Definition _EVP_md5_sha1 : ident := 248%positive.
Definition _EVP_md5_sha1_do_init : ident := 246%positive.
Definition _EVP_md5_sha1_init : ident := 247%positive.
Definition _EVP_md5_sha1_once : ident := 244%positive.
Definition _EVP_md5_sha1_once_bss_get : ident := 245%positive.
Definition _EVP_md5_sha1_storage : ident := 242%positive.
Definition _EVP_md5_sha1_storage_bss_get : ident := 243%positive.
Definition _EVP_md5_storage : ident := 181%positive.
Definition _EVP_md5_storage_bss_get : ident := 182%positive.
Definition _EVP_sha1 : ident := 197%positive.
Definition _EVP_sha1_do_init : ident := 195%positive.
Definition _EVP_sha1_init : ident := 196%positive.
Definition _EVP_sha1_once : ident := 193%positive.
Definition _EVP_sha1_once_bss_get : ident := 194%positive.
Definition _EVP_sha1_storage : ident := 191%positive.
Definition _EVP_sha1_storage_bss_get : ident := 192%positive.
Definition _EVP_sha224 : ident := 207%positive.
Definition _EVP_sha224_do_init : ident := 205%positive.
Definition _EVP_sha224_init : ident := 206%positive.
Definition _EVP_sha224_once : ident := 203%positive.
Definition _EVP_sha224_once_bss_get : ident := 204%positive.
Definition _EVP_sha224_storage : ident := 201%positive.
Definition _EVP_sha224_storage_bss_get : ident := 202%positive.
Definition _EVP_sha256 : ident := 217%positive.
Definition _EVP_sha256_do_init : ident := 215%positive.
Definition _EVP_sha256_init : ident := 216%positive.
Definition _EVP_sha256_once : ident := 213%positive.
Definition _EVP_sha256_once_bss_get : ident := 214%positive.
Definition _EVP_sha256_storage : ident := 211%positive.
Definition _EVP_sha256_storage_bss_get : ident := 212%positive.
Definition _EVP_sha384 : ident := 227%positive.
Definition _EVP_sha384_do_init : ident := 225%positive.
Definition _EVP_sha384_init : ident := 226%positive.
Definition _EVP_sha384_once : ident := 223%positive.
Definition _EVP_sha384_once_bss_get : ident := 224%positive.
Definition _EVP_sha384_storage : ident := 221%positive.
Definition _EVP_sha384_storage_bss_get : ident := 222%positive.
Definition _EVP_sha512 : ident := 237%positive.
Definition _EVP_sha512_do_init : ident := 235%positive.
Definition _EVP_sha512_init : ident := 236%positive.
Definition _EVP_sha512_once : ident := 233%positive.
Definition _EVP_sha512_once_bss_get : ident := 234%positive.
Definition _EVP_sha512_storage : ident := 231%positive.
Definition _EVP_sha512_storage_bss_get : ident := 232%positive.
Definition _MD4_Final : ident := 148%positive.
Definition _MD4_Init : ident := 146%positive.
Definition _MD4_Update : ident := 147%positive.
Definition _MD5_Final : ident := 151%positive.
Definition _MD5_Init : ident := 149%positive.
Definition _MD5_Update : ident := 150%positive.
Definition _Nh : ident := 123%positive.
Definition _Nl : ident := 122%positive.
Definition _OPENSSL_cleanse : ident := 75%positive.
Definition _OPENSSL_memcpy : ident := 79%positive.
Definition _OPENSSL_memset : ident := 81%positive.
Definition _SHA1_Final : ident := 154%positive.
Definition _SHA1_Init : ident := 152%positive.
Definition _SHA1_Update : ident := 153%positive.
Definition _SHA224_Final : ident := 157%positive.
Definition _SHA224_Init : ident := 155%positive.
Definition _SHA224_Update : ident := 156%positive.
Definition _SHA256_Final : ident := 160%positive.
Definition _SHA256_Init : ident := 158%positive.
Definition _SHA256_Update : ident := 159%positive.
Definition _SHA384_Final : ident := 163%positive.
Definition _SHA384_Init : ident := 161%positive.
Definition _SHA384_Update : ident := 162%positive.
Definition _SHA512_Final : ident := 166%positive.
Definition _SHA512_Init : ident := 164%positive.
Definition _SHA512_Update : ident := 165%positive.
Definition __2241 : ident := 134%positive.
Definition __2242 : ident := 132%positive.
Definition __2304 : ident := 140%positive.
Definition __3014 : ident := 145%positive.
...
Definition _c : ident := 80%positive.
Definition _count : ident := 109%positive.
Definition _ctx : ident := 87%positive.
Definition _ctx_size : ident := 16%positive.
Definition _d : ident := 138%positive.
Definition _data : ident := 102%positive.
Definition _digest : ident := 2%positive.
Definition _dst : ident := 76%positive.
Definition _dup : ident := 18%positive.
Definition _engine : ident := 98%positive.
Definition _engine_st : ident := 99%positive.
...
Definition _h : ident := 121%positive.
Definition _h0 : ident := 127%positive.
Definition _h1 : ident := 128%positive.
Definition _h2 : ident := 129%positive.
Definition _h3 : ident := 130%positive.
Definition _h4 : ident := 131%positive.
Definition _impl : ident := 112%positive.
Definition _in : ident := 93%positive.
Definition _init : ident := 12%positive.
Definition _len : ident := 103%positive.
Definition _main : ident := 120%positive.
Definition _malloc : ident := 74%positive.
Definition _md : ident := 82%positive.
Definition _md4_final : ident := 170%positive.
Definition _md4_init : ident := 168%positive.
Definition _md4_state_st : ident := 125%positive.
Definition _md4_update : ident := 169%positive.
Definition _md5 : ident := 143%positive.
Definition _md5_final : ident := 180%positive.
Definition _md5_init : ident := 178%positive.
Definition _md5_sha1_final : ident := 241%positive.
Definition _md5_sha1_init : ident := 239%positive.
Definition _md5_sha1_update : ident := 240%positive.
Definition _md5_state_st : ident := 126%positive.
Definition _md5_update : ident := 179%positive.
Definition _md_ctx : ident := 238%positive.
Definition _md_data : ident := 3%positive.
Definition _md_len : ident := 136%positive.
Definition _md_out : ident := 105%positive.
Definition _md_size : ident := 10%positive.
Definition _memcpy : ident := 71%positive.
Definition _memset : ident := 72%positive.
Definition _n : ident := 78%positive.
Definition _num : ident := 124%positive.
Definition _out : ident := 92%positive.
Definition _out_md : ident := 110%positive.
Definition _out_size : ident := 111%positive.
Definition _p : ident := 139%positive.
Definition _pctx : ident := 5%positive.
Definition _pctx_ops : ident := 7%positive.
Definition _ret : ident := 113%positive.
Definition _sha1 : ident := 144%positive.
Definition _sha1_final : ident := 190%positive.
Definition _sha1_init : ident := 188%positive.
Definition _sha1_update : ident := 189%positive.
Definition _sha224_final : ident := 200%positive.
Definition _sha224_init : ident := 198%positive.
Definition _sha224_update : ident := 199%positive.
Definition _sha256_final : ident := 210%positive.
Definition _sha256_init : ident := 208%positive.
Definition _sha256_state_st : ident := 137%positive.
Definition _sha256_update : ident := 209%positive.
Definition _sha384_final : ident := 220%positive.
Definition _sha384_init : ident := 218%positive.
Definition _sha384_update : ident := 219%positive.
Definition _sha512_final : ident := 230%positive.
Definition _sha512_init : ident := 228%positive.
Definition _sha512_state_st : ident := 142%positive.
Definition _sha512_update : ident := 229%positive.
Definition _sha_state_st : ident := 135%positive.
Definition _size : ident := 106%positive.
Definition _src : ident := 77%positive.
Definition _tmp_buf : ident := 94%positive.
Definition _type : ident := 9%positive.
Definition _u : ident := 141%positive.
Definition _update : ident := 13%positive.
Definition _t'1 : ident := 249%positive.
Definition _t'2 : ident := 250%positive.
Definition _t'3 : ident := 251%positive.
...
Definition f_md5_sha1_init := {|
  ...
  fn_vars := nil;
  fn_temps := ((_ctx, (tptr (Tstruct __3014 noattr))) :: (_t'3, tint) ::
...
(Ssequence
  ...
  (Ssequence
    (Scall (Some _t'1)
      ...
      ((Eaddrof
         (Efield
           (Ederef (Etempvar _ctx (tptr (Tstruct __3014 noattr)))
             (Tstruct __3014 noattr)) _md5 (Tstruct _md5_state_st noattr))
            ...
            (Ssequence
              ...
              (Sassign
                (Efield
                  (Ederef (Etempvar _out (tptr (Tstruct _env_md_st noattr)))
                    (Tstruct _env_md_st noattr)) _ctx_size tuint)
                (Esizeof (Tstruct __3014 noattr) tuint)))))))))
|}.
...
(Composite _env_md_ctx_st Struct
 ...
 Composite _md5_state_st Struct
   ((_h, (tarray tuint 4)) :: (_Nl, tuint) :: (_Nh, tuint) ::
    (_data, (tarray tuchar 64)) :: (_num, tuint) :: nil)
   noattr ::
 Composite __2242 Struct
   ((_h0, tuint) :: (_h1, tuint) :: (_h2, tuint) :: (_h3, tuint) ::
    (_h4, tuint) :: nil)
   noattr ::
 Composite __2241 Union
   ((_h, (tarray tuint 5)) :: (133%positive, (Tstruct __2242 noattr)) :: nil)
   noattr ::
 Composite _sha_state_st Struct
   ((133%positive, (Tunion __2241 noattr)) :: (_Nl, tuint) :: (_Nh, tuint) ::
    (_data, (tarray tuchar 64)) :: (_num, tuint) :: nil)
   noattr ::
